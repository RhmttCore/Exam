...
dan juga sudah di tandai sebagai user blacklist`
...
jangan lupa baca dan ikuti rules group
semoga betah yak`
...
case 'promote':{
const promoteText = (chat.sPromote || '@user selamat karena telah dirpomote').replace('user', await conn.getName(sender))     
...
case 'demote':{
const demoteText = (chat.sDemote || '@user makanya yang becus jadi admin').replace('user', await conn.getName(sender))      
