...
return result
  ...
  pack: "Ciyo", //the pack name
  author: "RhmttCore", //the author name
...
return await conn.sendMessage(jid, { [`${pase}`]: data, mimetype: mime, ...options }, { quoted })
  ...
  */
  ...
  +"item2.EMAIL;type=INTERNET: rhmtthdytt123@gmail.com\n"
  +"item2.X-ABLabel:Email\nitem3.URL:https://github.com/RhmttCore\n"
